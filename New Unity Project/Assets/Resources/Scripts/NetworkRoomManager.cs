...
namespace Mirror
{
    ...
    /// </remarks>
    [AddComponentMenu("Mirror/NetworkRoomManager")]
    [HelpURL("https://mirror-networking.com/xmldocs/Components/NetworkRoomManager.html")]
    public class NetworkRoomManager : NetworkManager
    {
        ...
        [SerializeField]
        internal bool allowLocalPlayers = true;
        ...
        public virtual void OnGUI()
        {
            ...
            // maybe resize , which will depend on sum of all clients/players
            if (allPlayersReady && showStartButton && GUI.Button(new Rect(10f, 140f, 120f, 20f), "START GAME"))
            {
